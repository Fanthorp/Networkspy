...
def request_ping(data_type,data_code,data_checksum,data_ID,data_Sequence,payload_body):
    ...
    reply ping
    '''
def reply_ping(send_request_ping_time,rawsocket,data_Sequence,timeout = 1.5):
    while True:
...
if __name__ == "__main__":
    list1 = ["202.85.215.3","202.85.215.2","202.85.215.10","202.85.215.11","202.85.215.1","202.85.215.2","202.85.215.8","202.85.215.147"]
    ...
    threads = []
    for i in list1:
        thread = Thread(target=runping, args=(i,))
        thread.start()   
